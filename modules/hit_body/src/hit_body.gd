...
# Adds a new hit property to this body
# hit_name: String identifier for the property
...
# Retrieves a hit property by name
# hit_name: String identifier of the property to get
